...
def check_password():
    ...
    if "password_correct" not in st.session_state:
        # Primera vez que entra, mostrar input
        st.text_input(
            "🔒 Esta herramienta es privada. Por favor ingresa la contraseña de acceso:", 
            type="password", 
...
if check_password():
    ...
    with st.sidebar:
        ...
        st.write("---")
        st.write("Configuración: Modo Seguro (Reintentos activados).")
